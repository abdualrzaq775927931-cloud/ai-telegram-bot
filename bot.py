...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_msg = (
        f"مرحباً <b>{user.mention_html()}</b>! 🌟\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "📝 <b>صيغة إضافة سؤال:</b>\n"
        "<code>/add_quiz Name;Question;Correct;W1;W2;W3</code>"
    )
...
async def admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    admin_msg = (
        ...
        "⚙️ <b>الإجراءات المتاحة:</b> /broadcast"
    )
...
async def leaderboard_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_html(lb_text)
...
async def add_quiz_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not lines:
        await update.message.reply_text("استخدم: <code>/add_quiz Name;Q;Correct;W1;W2;W3</code>", parse_mode=ParseMode.HTML)
        return
    count = 0
    for line in lines:
